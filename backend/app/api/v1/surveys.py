...
from app.schemas import (
    SurveyCreate, SurveyUpdate, SurveyListItem, 
...
from app.core.exceptions import (
    ...
    ValidationException, InsufficientBalanceException
)
...
@router.post("/my/", response_model=MySurveyDetail, status_code=status.HTTP_201_CREATED)
async def create_survey(
    ...
    """Создать новый опрос"""
    try:
        survey = survey_service.create_survey(survey_data, current_user.id)
